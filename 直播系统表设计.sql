...
CREATE TABLE `live_home_banner` (
  ...
  `sort` int(9) DEFAULT NULL COMMENT '序号',
...
CREATE TABLE `live_report_data_download` (
  ...
  `update_date` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_report_room_data_user_id` (`room_id`,`type`,`data_id`,`user_id`) USING BTREE
...
CREATE TABLE `live_room_rich_text` (
  `id` int(9) NOT NULL,
  `room_id` int(9) NOT NULL COMMENT '直播房间id',
  `content` varchar(1000) NOT NULL COMMENT '图文内容',
...
CREATE TABLE `sys_file` (
  ...
  `ext` varchar(64) NOT NULL COMMENT '文件后缀名',
