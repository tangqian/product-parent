        ...
        <input type="hidden" name="callback" value="${callback}" />
            ...
            <div class="login-input-box">
                ...
                <div class="login-input-fd">
                    <a href="http://www.ofweek.com/user/userGetPassword.do" target="_blank" class="forget-password">忘记密码</a>
                </div>
            </div>
            <!-- 验证码 -->
            ...
            <div class="login-input-box">
                ...
                <div class="login-input-fd">
                    <p class="login-reg">还不是OFweek会员？<a href="http://www.ofweek.com/user/registerUser.do" target="_blank" class="red">立即注册</a></p>
                </div>
            </div>
            <!-- -->
        </form>
				...
				$(form).ajaxSubmit({
					...
					success:function( data ){
						if (data && data.sessionid) {
							if ("${callback}".indexOf("http://live.ofweek.com") != -1) {
