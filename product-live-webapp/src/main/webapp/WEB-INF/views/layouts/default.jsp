...
<div id="g-topbar" class="g-topbar">
	<div class="g-wrap">
		<div class="g-topbar-nav">
			<a href="http://www.ofweek.com/" target="_blank" class="ofweek-index">OFweek首页</a>
		</div>
		...
		<c:choose>
			...
			<c:otherwise>
				<li id="g-topbar-logininfo" class="g-topbar-logininfo">
					...
					<a href="http://www.ofweek.com/user/registerUser.do" rel="nofollow" target="_blank">注册</a> <i>|</i>
	...
	<div class="login_header">
		<div class="wrapper">
			...
			<ul class="live-nav">
				<li><h3><a href="http://live.ofweek.com/">直播首页</a></h3></li>
				<li>
					<h3>直播预告</h3>
					<div class="live-sub-nav">
						<c:if test="${isTrailer eq 1}">
							<a href="${ctx}/index/trailer" target="_blank">直播</a>
						</c:if>
						<a href="http://expo.ofweek.com/upcommingExh.xhtml" target="_blank">在线展会</a>
						<a href="http://webinar.ofweek.com/futureConduct.action?user.id=2" target="_blank">在线研讨会</a>
					</div>
				</li>
				<li class="last">
					<h3>直播回顾</h3>
					<div class="live-sub-nav">
						<a href="${ctx}/index/review" target="_blank">直播</a>
	...
	<div class="foot clearfix">
		<div class="foot-wrap">
			<p class="footer-links">
				...
				<a target="_blank" href="http://www.ofweek.com/about/company.html">关于我们</a> -
